    ...
    <div class="personal_area">
      ...
      <div class="card">
        <div class="card_title">
          ...
          <a href="" class="card_title__look">Посмотреть</a>
        </div>
        <div class="card_body">
      ...
      <div class="card">
        <div class="card_title">
          ...
          <img src="{{ Vite::asset('resources/images/icons/edit.svg') }}" alt="" class="card_title__icon">
        </div>
        <div class="card_body">
      ...
      <div class="card">
        ...
        <span class="card_add_btn" onclick="addContact()">Добавить контакты</span>
      </div>
