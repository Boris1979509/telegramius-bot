...
@else
  <div class="product_add__icon-wrap" data-show="{{ $product->id }}">
    <img
      ...
      src="{{ Vite::asset('resources/images/icons/shopping-cart.svg') }}"
  ...
  <div class="product_change_count__wrap row">
    <img
      ...
      src="{{ Vite::asset('resources/images/icons/minus-icon.svg') }}"
      alt=""
      class="product_change_count__icon product_change_count__icon-minus"
    />
    <input
      type="text"
      id="item-total-qty-{{ $product->id }}"
      class="product_change_count__value"
      disabled
    />
    <img
      onclick="addItem('{{ $product->id }}')"
      src="{{ Vite::asset('resources/images/icons/plus-icon.svg') }}"
      alt=""
      class="product_change_count__icon product_change_count__icon-plus"
    />
  </div>
@endif
